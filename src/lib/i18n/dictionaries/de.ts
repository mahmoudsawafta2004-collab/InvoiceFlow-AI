...
const de: Dictionary = {
  ...
  auth: {
    login: {
      ...
      subtitle: "Melde dich an, um deine Rechnungen zu konvertieren.",
      email: "E-Mail",
      password: "Passwort",
      forgot: "Vergessen?",
      submit: "Anmelden",
    ...
    signup: {
      ...
      subtitle: "Startet im kostenlosen Tarif — ohne Karte.",
      ...
      signIn: "Anmelden",
      agree: "Mit dem Fortfahren akzeptierst du unsere",
      and: "und",
      sentTitle: "Prüfe deine E-Mails",
      sentBody: (email: string) =>
        `Wir haben einen Bestätigungslink an ${email} geschickt. Klicke ihn an, um dein Konto zu aktivieren.`,
      alreadyRegistered:
  ...
  admin: {
    ...
    subtitle: "Abonnenten, Nutzung und Preise — nur für freigeschaltete Konten sichtbar.",
    stats: {
      totalUsers: "Nutzer insgesamt",
      payingSubscribers: "Zahlende Abonnenten",
      mrr: "Monatlich wiederkehrender Umsatz",
      invoicesThisMonth: "Rechnungen diesen Monat",
    },
    plans: {
      title: "Tarife",
      note: "Eine Preisänderung hier gilt sofort für neue Zahlungen — auf Stripe-Seite ist nichts anzupassen.",
      name: "Tarifname",
      price: "Preis / Monat (USD)",
      limit: "Rechnungen / Monat",
      save: "Speichern",
      saved: "Gespeichert",
      invalidNumbers: "Gib gültige Zahlen ein.",
      saveFailed: "Speichern fehlgeschlagen.",
    },
    users: {
      title: "Abonnenten",
      count: (n: number) => `${n} Konto${n === 1 ? "" : "s"}`,
      colUser: "Nutzer",
      colPlan: "Tarif",
      colStatus: "Status",
      colUsage: "Nutzung in dieser Periode",
      colJoined: "Beigetreten",
      empty: "Noch keine Abonnenten.",
      moved: (email: string, plan: string) => `${email} zu ${plan} verschoben`,
  ...
  billing: {
    ...
    invoicesThisPeriod: (used: number, limit: string) =>
      `${used} / ${limit} Rechnungen in dieser Periode`,
    adminTitle: "Administratorkonto",
    adminBody: "Unbegrenzte Extraktionen — kein Abo nötig.",
    comingSoon: "Der Checkout öffnet sich, sobald die Abrechnung verbunden ist.",
