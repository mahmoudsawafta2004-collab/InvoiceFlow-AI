...
const fr: Dictionary = {
  ...
  auth: {
    login: {
      title: "Bon retour",
      subtitle: "Connectez-vous pour convertir vos factures.",
      email: "E-mail",
    ...
    signup: {
      ...
      subtitle: "Commence sur le plan gratuit — sans carte.",
      name: "Nom complet",
      email: "E-mail",
      password: "Mot de passe",
  ...
  admin: {
    ...
    subtitle: "Abonnés, usage et tarifs — visible uniquement pour les comptes autorisés.",
    stats: {
      totalUsers: "Utilisateurs au total",
      payingSubscribers: "Abonnés payants",
      mrr: "Revenu mensuel récurrent",
      invoicesThisMonth: "Factures ce mois-ci",
    },
    plans: {
      title: "Formules",
      note: "Modifier un prix ici change immédiatement les nouveaux paiements — rien à mettre à jour côté Stripe.",
      name: "Nom de la formule",
      price: "Prix / mois (USD)",
      limit: "Factures / mois",
      save: "Enregistrer",
      saved: "Enregistré",
      invalidNumbers: "Saisissez des nombres valides.",
    ...
    users: {
      ...
      colPlan: "Formule",
      colStatus: "Statut",
      colUsage: "Usage cette période",
      colJoined: "Inscription",
      empty: "Aucun abonné pour l'instant.",
      moved: (email: string, plan: string) => `${email} déplacé vers ${plan}`,
  ...
  billing: {
    ...
    invoicesThisPeriod: (used: number, limit: string) =>
      `${used} / ${limit} factures cette période`,
    adminTitle: "Compte administrateur",
    adminBody: "Extractions illimitées — sans abonnement.",
    comingSoon: "Le paiement s'ouvrira une fois la facturation connectée.",
