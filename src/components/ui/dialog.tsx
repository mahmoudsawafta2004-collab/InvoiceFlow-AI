...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm text-neutral-400 transition-colors hover:text-neutral-900 focus-visible:outline-none">
        <X className="h-4 w-4" />
